...
public class ThemeHelper {
    ...
    public int getBackgroundColor() {
        ...
        switch (baseTheme) {
            case DARK_THEME:
                color = getColor(org.horaapps.leafpic.R.color.md_dark_background);
                break;
            case AMOLED_THEME:
                color = getColor(org.horaapps.leafpic.R.color.md_black_1000);
                break;
            case LIGHT_THEME:
            default:
                color = getColor(org.horaapps.leafpic.R.color.md_light_background);
        }
        return color;
    }
    ...
    public int getTextColor() {
        ...
        switch (baseTheme) {
            case DARK_THEME:
                color = getColor(org.horaapps.leafpic.R.color.md_grey_200);
                break;
            case AMOLED_THEME:
                color = getColor(org.horaapps.leafpic.R.color.md_grey_200);
                break;
            case LIGHT_THEME:
            default:
                color = getColor(org.horaapps.leafpic.R.color.md_grey_800);
        }
        return color;
    }
    ...
    public int getSubTextColor() {
        ...
        switch (baseTheme) {
            case DARK_THEME:
                color = getColor(org.horaapps.leafpic.R.color.md_grey_400);
                break;
            case AMOLED_THEME:
                color = getColor(org.horaapps.leafpic.R.color.md_grey_400);
                break;
            case LIGHT_THEME:
            default:
                color = getColor(org.horaapps.leafpic.R.color.md_grey_600);
        }
        return color;
    }
    ...
    public int getCardBackgroundColor() {
        ...
        switch (baseTheme) {
            case DARK_THEME:
                color = getColor(org.horaapps.leafpic.R.color.md_dark_cards);
                break;
            case AMOLED_THEME:
                color = getColor(org.horaapps.leafpic.R.color.md_black_1000);
                break;
            case LIGHT_THEME:
            default:
                color = getColor(org.horaapps.leafpic.R.color.md_light_cards);
        }
        return color;
    }
    ...
    public int getIconColor() {
        ...
        switch (baseTheme) {
            case DARK_THEME:
            case AMOLED_THEME:
                color = getColor(org.horaapps.leafpic.R.color.md_white_1000);
                break;
            case LIGHT_THEME:
            default:
                color = getColor(org.horaapps.leafpic.R.color.md_light_primary_icon);
        }
        return color;
    }
    ...
    public Drawable getPlaceHolder() {
        switch (baseTheme) {
            case DARK_THEME:
                return ContextCompat.getDrawable(context, org.horaapps.leafpic.R.drawable.ic_empty);
            case AMOLED_THEME:
                return ContextCompat.getDrawable(context, org.horaapps.leafpic.R.drawable.ic_empty_amoled);
            case LIGHT_THEME:
                return ContextCompat.getDrawable(context, org.horaapps.leafpic.R.drawable.ic_empty_white);
        }
        return null;
    }
    ...
    public int getDialogStyle() {
        ...
        switch (getBaseTheme()) {
            case DARK_THEME:
                style = org.horaapps.leafpic.R.style.AlertDialog_Dark;
                break;
            case AMOLED_THEME:
                style = org.horaapps.leafpic.R.style.AlertDialog_Dark_Amoled;
                break;
            case LIGHT_THEME:
            default:
                style = org.horaapps.leafpic.R.style.AlertDialog_Light;
                break;
        }
        return style;
    }
    ...
    public int getPopupToolbarStyle() {
        ...
        switch (getBaseTheme()) {
            case DARK_THEME:
                style = org.horaapps.leafpic.R.style.DarkActionBarMenu;
                break;
            case AMOLED_THEME:
                style = org.horaapps.leafpic.R.style.AmoledDarkActionBarMenu;
                break;
            case LIGHT_THEME:
            default:
                style = org.horaapps.leafpic.R.style.LightActionBarMenu;
        }
        return style;
    }
    ...
    public ArrayAdapter<String> getSpinnerAdapter(ArrayList<String> items) {
        switch (getBaseTheme()) {
            case AMOLED_THEME:
            case DARK_THEME:
                return new ArrayAdapter<String>(context, org.horaapps.leafpic.R.layout.spinner_item_light, items);
            case LIGHT_THEME:
            default:
                return new ArrayAdapter<String>(context, org.horaapps.leafpic.R.layout.spinner_item_dark, items);
        }
    }
    ...
    public int getDefaultThemeToolbarColor3th() {
        ...
        switch (baseTheme) {
            case DARK_THEME:
                ...
                break;
            case AMOLED_THEME:
                color = getColor(org.horaapps.leafpic.R.color.md_blue_grey_800);
                break;
            case LIGHT_THEME:
            default:
                color = getColor(org.horaapps.leafpic.R.color.md_blue_grey_800);
